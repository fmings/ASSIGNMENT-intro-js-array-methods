...
// Reusable function to get the cards on the DOM - DONE
// .forEach()
...
const search = (event) => {
  ...
  const searchResult = referenceList.filter(item => 
    ...
    item.type.toLowerCase().includes(eventLC) ||
...
// RESHAPE DATA TO RENDER TO DOM - DONE
// .map()
const productList = () => {
